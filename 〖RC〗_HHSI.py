...
if __name__ == "__main__":
    ...
    input_shp = r"G:\06Python_Study\Project\TEST\11LST_UTCI_Exposure\DATA_RESULT\11_01DATA\global_all_country_HE-LFT_POP.shp"
    #in_folder = r"G:\06Python_Study\Project\TEST\09UTCI_World_DATA\10_03Data"##栅格所在的文件夹
    in_folder = r"K:\E_LST&UTCI_Exposure\Data03_UTCI_07_HE-LFT_01POP"  ##栅格所在的文件夹
    Stats_type = 'sum'
