...
# 定义输入和输出的栅格文件路径
input1 = r"K:\E_LST&UTCI_Exposure\Data03_UTCI_01_HZA\2021_UTCI_HZA.tif"
input2 = r"K:\E_LST&UTCI_Exposure\Data03_UTCI_02_HZI\RESULT_Annual_HZI\2021_UTCI_HZI.tif"
input3 = r"K:\E_LST&UTCI_Exposure\Data03_UTCI_03_HZQ\2021_UTCI_HZQ.tif"
output = r"K:\E_LST&UTCI_Exposure\TEST\2021_HZA×HZI×HZQ.tif"
...
with rasterio.open(input3) as src3:
    data3 = src3.read(1) # 读取第一个波段的数据
...
profile.update(nodata=0, dtype=np.int16)
